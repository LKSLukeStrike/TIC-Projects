            ...
            for _entity, _ in pairs(_playerlocationsaround[_keyy][_keyx]) do -- entities around actual player
                ...
                or _entityinmind then
                    ...
                    if _entity.discovered then -- handle only discovered entities
                        ...
                        and Tic:screenActual() == Tic:screenLast() then -- allows interactions only if top screen (no menus)
...
function CWindowMessagesWorld:new(_argt)
    ...
    self.buttontext  = CButtonMessageText{}
    ...
    self.buttontext.screenx = self.screenx
    self.buttontext.screeny = self.screeny
    self.buttontext.screenw = self.screenw
    self.buttontext.screenh = self.screenh
end

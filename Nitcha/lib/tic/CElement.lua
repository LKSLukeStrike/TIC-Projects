...
function CElement:new(_argt)
    ...
    self.hovertextlf = nil   -- hover CText lf -- FIXMEnadd more rotations ? -- FIXME add modifier key texts ?
    self.hovertextrg = nil   -- hover CText rg
    self.hovertextup = nil   -- hover CText up
    self.hovertextdw = nil   -- hover CText dw
